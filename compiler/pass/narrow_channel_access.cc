...
namespace ir {
    ...
    public:
        Stmt Mutate_(const AttrStmt* op, const Stmt& s) final
        {
            ...
            if ((op->attr_key == ir::attr::channel_read_scope && adv && adv->attr_key == ir::attr::channel_read_advance) || (op->attr_key == ir::attr::channel_write_scope && adv && adv->attr_key == ir::attr::channel_write_advance)) {
                RewriteEntry e;
                e.window = op;
                e.advance = adv;
