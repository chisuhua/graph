...
namespace codegen {
    ...
    {
        std::shared_ptr<SourceModuleNode> n = std::make_shared<SourceModuleNode>(code, fmt);
    ...
    {
        std::shared_ptr<CSourceModuleNode> n = std::make_shared<CSourceModuleNode>(code, fmt);
        return runtime::Module(n);
    }
    ...
    runtime::Module DeviceSourceModuleCreate(
        ...
        std::function<std::string(const std::string&)> fget_source)
    {
        std::shared_ptr<DeviceSourceModuleNode> n = std::make_shared<DeviceSourceModuleNode>(data, fmt, fmap, type_key, fget_source);
        return runtime::Module(n);
    }
