...
namespace codegen {
    ...
    void CodeGenCHost::PrintType(Type t, std::ostream& os)
    { // NOLINT(*)
        int lanes = t.lanes();
        if (t.is_handle()) {
            CHECK_EQ(lanes, 1)
    ...
    void CodeGenCHost::VisitExpr_(const Broadcast* op, std::ostream& os)
    { // NOLINT(*)
    ...
    void CodeGenCHost::VisitExpr_(const Call* op, std::ostream& os)
    { // NOLINT(*)
    ...
    void CodeGenCHost::VisitStmt_(const AssertStmt* op)
    { // NOLINT(*)
    ...
    void CodeGenCHost::VisitExpr_(const Min* op, std::ostream& os)
    { // NOLINT(*)
        PrintTernaryCondExpr(op, "<", os);
    }

    void CodeGenCHost::VisitExpr_(const Max* op, std::ostream& os)
    { // NOLINT(*)
        PrintTernaryCondExpr(op, ">", os);
    }
