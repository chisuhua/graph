...
namespace codegen {
    ...
    void CodeGenOpenCL::PrintType(Type t, std::ostream& os)
    { // NOLINT(*)
        int lanes = t.lanes();
        if (t.is_handle()) {
            CHECK_EQ(lanes, 1)
    ...
    void CodeGenOpenCL::VisitExpr_(const Broadcast* op, std::ostream& os)
    { // NOLINT(*)
    ...
    void CodeGenOpenCL::VisitExpr_(const Call* op, std::ostream& os)
    { // NOLINT(*)
   ...
   * add a cast */
    ...
    void CodeGenOpenCL::VisitExpr_(const Select* op, std::ostream& os)
    { // NOLINT(*)
        /* Return type of ternary expression is not always same as its sub-expressions,
   * add a cast */
        os << "(";
    ...
    void CodeGenOpenCL::VisitExpr_(const FloatImm* op, std::ostream& os)
    { // NOLINT(*)
