...
namespace codegen {
    namespace spirv {
        ...
        void IRBuilder::InitHeader()
        {
            ...
            // memory model
            ib_.Begin(spv::OpMemoryModel).AddSeq(spv::AddressingModelLogical, spv::MemoryModelGLSL450).Commit(&entry_);
            this->InitPreDefs();
        }
