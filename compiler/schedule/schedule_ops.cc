...
namespace schedule {
    ...
    public:
        ...
        Stmt Mutate(Stmt stmt) final
        {
            ...
            // update
            const AttrStmt* op = stmt.as<AttrStmt>();
            if (op != nullptr && ((op->attr_key == attr::scan_update_scope && !is_init_) || (op->attr_key == attr::scan_init_scope && is_init_))) {
    ...
    public:
        ...
        Stmt Mutate_(const AttrStmt* op, const Stmt& s) final
        {
            ...
            } else if (op->attr_key == ir::attr::realize_scope || op->attr_key == ir::attr::double_buffer_scope) {
