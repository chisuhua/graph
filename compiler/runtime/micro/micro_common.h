 ...
 */
    ...
    public:
        ...
        explicit DeviceLocation(std::uintptr_t value)
            : value_(value)
        {
        }
        ...
        explicit DeviceLocation(std::nullptr_t value)
            : value_(0)
        {
        }
   ...
   */
    ...
    public:
        ...
        explicit DevPtr(std::uintptr_t val)
            : DeviceLocation(val)
        {
        }
        ...
        explicit DevPtr(std::nullptr_t val)
            : DeviceLocation(val)
        {
        }
    ...
    public:
        ...
        explicit DevBaseOffset(std::uintptr_t value)
        ...
        explicit DevBaseOffset(std::nullptr_t value)
            : DeviceLocation(value)
        {
        }
