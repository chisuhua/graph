...
namespace relay {
    ...
    struct TakeAttrs : public tvm::AttrsNode<TakeAttrs> {
        ...
        {
            TVM_ATTR_FIELD(axis).set_default(NullValue<Integer>()).describe("The axis over which to select values.");
            TVM_ATTR_FIELD(mode).set_default("clip").describe("Specify how out-of-bound indices will behave."
    ...
    struct StackAttrs : public tvm::AttrsNode<StackAttrs> {
        ...
        {
            TVM_ATTR_FIELD(axis).set_default(0).describe("The axis in the result array along which the input arrays are stacked.");
        }
    }; // struct StackAttrs
    ...
    struct RepeatAttrs : public tvm::AttrsNode<RepeatAttrs> {
        ...
        TVM_DECLARE_ATTRS(RepeatAttrs, "relay.attrs.RepeatAttrs")
        {
            ...
            TVM_ATTR_FIELD(axis).set_default(NullValue<Integer>()).describe(" The axis along which to repeat values.");
        }
    }; // struct RepeatAttrs
    ...
    struct ReverseAttrs : public tvm::AttrsNode<ReverseAttrs> {
        ...
        {
            TVM_ATTR_FIELD(axis).set_default(NullValue<Integer>()).describe("The axis along which to reverse elements.");
        }
    }; // struct ReverseAttrs
    ...
    struct SequenceMaskAttrs : public tvm::AttrsNode<SequenceMaskAttrs> {
        ...
        TVM_DECLARE_ATTRS(SequenceMaskAttrs, "relay.attrs.SequenceMaskAttrs")
        {
            ...
            TVM_ATTR_FIELD(axis).set_default(0).describe("The axis of the length dimension. Can only be 0 or 1.");
        }
