...
namespace runtime {
   ...
   */
    ...
    protected:
        ...
        explicit ObjectCell(ObjectTag tag)
            : tag(tag)
        {
        }
 ...
 */
    ...
    public:
        ...
        explicit Object(ObjectPtr<ObjectCell> ptr)
            : ptr_(ptr)
        {
        }
        explicit Object(ObjectCell* ptr)
            : ptr_(ptr)
        {
        }
        Object()
    ...
    struct DatatypeCell : public ObjectCell {
        ...
        DatatypeCell(size_t tag, const std::vector<Object>& fields)
            : ObjectCell(ObjectTag::kDatatype)
            , tag(tag)
            , fields(fields)
        {
        }
