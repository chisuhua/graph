...
if(USE_ROCM)
  ...
  file(GLOB RUNTIME_ROCM_SRCS ${COMPILER_SRC_DIR}/runtime/rocm/*.cc)
  ...
  if(USE_MIOPEN)
    ...
    file(GLOB MIOPEN_CONTRIB_SRCS ${COMPILER_SRC_DIR}/contrib/miopen/*.cc)
  ...
  if(USE_ROCBLAS)
    ...
    file(GLOB ROCBLAS_CONTRIB_SRCS ${COMPILER_SRC_DIR}/contrib/rocblas/*.cc)
    list(APPEND RUNTIME_SRCS ${ROCBLAS_CONTRIB_SRCS})
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${ROCM_ROCBLAS_LIBRARY})
  endif(USE_ROCBLAS)
else(USE_ROCM)
  list(APPEND COMPILER_SRCS ${COMPILER_SRC_DIR}/codegen/opt/build_rocm_off.cc)
endif(USE_ROCM)
