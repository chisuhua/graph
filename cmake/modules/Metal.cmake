...
if(USE_METAL)
  ...
  file(GLOB RUNTIME_METAL_SRCS ${COMPILER_SRC_DIR}/runtime/metal/*.mm)
  list(APPEND TVM_RUNTIME_LINKER_LIBS ${METAL_LIB} ${FOUNDATION_LIB})
  list(APPEND RUNTIME_SRCS ${RUNTIME_METAL_SRCS})

  if(USE_MPS)
    file(GLOB MPS_CONTRIB_SRC ${COMPILER_SRC_DIR}/contrib/mps/*.mm)
  ...
  list(APPEND COMPILER_SRCS ${COMPILER_SRC_DIR}/codegen/opt/build_metal_off.cc)
endif(USE_METAL)
