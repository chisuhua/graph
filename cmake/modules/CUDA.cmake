...
if(USE_CUDA)
  ...
  file(GLOB RUNTIME_CUDA_SRCS ${COMPILER_SRC_DIR}/runtime/cuda/*.cc)
  list(APPEND RUNTIME_SRCS ${RUNTIME_CUDA_SRCS})
  list(APPEND COMPILER_SRCS ${COMPILER_SRC_DIR}/codegen/opt/build_cuda_on.cc)
  ...
  if(USE_CUDNN)
    ...
    file(GLOB CONTRIB_CUDNN_SRCS ${COMPILER_SRC_DIR}/contrib/cudnn/*.cc)
  ...
  if(USE_CUBLAS)
    ...
    file(GLOB CONTRIB_CUBLAS_SRCS ${COMPILER_SRC_DIR}/contrib/cublas/*.cc)
    list(APPEND RUNTIME_SRCS ${CONTRIB_CUBLAS_SRCS})
    list(APPEND TVM_RUNTIME_LINKER_LIBS ${CUDA_CUBLAS_LIBRARY})
  endif(USE_CUBLAS)

else(USE_CUDA)
	list(APPEND COMPILER_SRCS ${COMPILER_SRC_DIR}/codegen/opt/build_cuda_off.cc)
endif(USE_CUDA)
