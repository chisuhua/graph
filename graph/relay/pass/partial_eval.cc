 ...
 */
        ...
        public:
            Static() {}
            explicit Static(NodePtr<Node> n)
                : NodeRef(n)
            {
            }
        ...
        struct PStaticNode : Node {
            ...
            explicit PStaticNode(const Expr& dynamic)
                : PStaticNode(Static(), dynamic)
            {
            }
        ...
        struct STupleNode : StaticNode {
            ...
            explicit STupleNode(const std::vector<PStatic>& fields)
                : fields(fields)
            {
            }
        ...
        struct STensorNode : StaticNode {
            ...
            explicit STensorNode(const NDArray& data)
                : data(data)
            {
            }
        ...
        struct SFuncNode : StaticNode {
            Func func;
            explicit SFuncNode(const Func& func)
                : func(func)
            {
            }
 ...
 */
   ...
   */
        ...
        struct FSeqNode : FuelNode {
            ...
            explicit FSeqNode(const std::vector<Fuel>& fuels)
                : fuels(fuels)
            {
            }
        ...
        struct FTValueNode : FuelNode {
            ...
            explicit FTValueNode(size_t tvalue)
                : tvalue(tvalue)
            {
            }
 ...
 */
        ...
        private:
            ...
            struct FrameContext {
                Environment* env_;
                explicit FrameContext(Environment* env)
                    : env_(env)
                {
 ...
 */
   ...
   */
            ...
            explicit StoreFrame(const std::unordered_map<const SRefNode*, PStatic>& store)
                : store(store)
            {
            }
            StoreFrame() = default;
        ...
        private:
            ...
            struct StoreFrameContext {
                Store* store_;
                explicit StoreFrameContext(Store* store)
                    : store_(store)
                {
 ...
 */
        ...
        public:
            PartialEvaluator(const Module& mod)
                : mod_(mod)
            {
            }
            ...
            struct ReflectError : dmlc::Error {
                ReflectError()
                    : dmlc::Error("static value not found")
                {
                }
            };
            ...
            void InitializeFuncId(const Expr& e)
            {
                struct InitializeFuncIdVisitor : ExprVisitor, PatternVisitor {
                    PartialEvaluator* pe;
                    explicit InitializeFuncIdVisitor(PartialEvaluator* pe)
                        : pe(pe)
                    {
                    }
            ...
            Expr RegisterFuncId(const Expr& e)
            {
                struct RegisterFuncIdVisitor : ExprVisitor, PatternVisitor {
                    PartialEvaluator* pe;
                    explicit RegisterFuncIdVisitor(PartialEvaluator* pe)
                        : pe(pe)
                    {
                    }
            ...
            Expr AnnotateFuncId(const Expr& e)
            {
                struct AnnotateFuncIdMutator : ExprMutator, PatternMutator {
                    PartialEvaluator* pe;
                    explicit AnnotateFuncIdMutator(PartialEvaluator* pe)
                        : pe(pe)
                    {
                    }
