 ...
 */
    struct ScopeNode {
        ...
        explicit ScopeNode(const Scope& parent)
 ...
 */
    ...
    private:
        ...
        {
            Var var = v.defined() ? v : VarNode::make(std::string("x"), Type());
   ...
   */
    ...
    Module ToANormalForm(const Module& m)
    {
        ...
        for (const auto& it : funcs) {
            ...
            Expr ret = TransformF([&](const Expr& e) {
        ...
        DLOG(INFO) << "ToANF: transformed" << std::endl
                   << m;
