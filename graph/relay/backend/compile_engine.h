...
namespace relay {
   ...
   */
    ...
    public:
        CCacheKey() {}
        explicit CCacheKey(NodePtr<Node> n)
            : NodeRef(n)
        {
        }
    ...
    public:
        CCacheValue() {}
        explicit CCacheValue(NodePtr<Node> n)
            : NodeRef(n)
        {
        }
 ...
 */
   ...
   */
    ...
    public:
        CompileEngine() {}
        explicit CompileEngine(NodePtr<Node> n)
            : NodeRef(n)
        {
        }
 ...
 */
        ...
        const CCacheKeyNode* other) const
    {
        if (Hash() != other->Hash())
            return false;
        return this->target->str() == other->target->str() && AlphaEqual(this->source_func, other->source_func);
    }
