 ...
 */
#include <halide/node/container.h>
#include <halide/node/ir_functor.h>
#include <halide/node/memory.h>
#include <halide/node/node.h>

#include <string>
#include <vector>

#include "halide/base/debug.h"
#include "halide/base/error.h"
#include "halide/base/float16.h"
#include "halide/base/type.h"
#include "halide/base/util.h"
...
struct VarExpr : public Expr {
    ...
    explicit VarExpr(NodePtr<Node> n)
        : Expr(n)
    {
    }
    /**
