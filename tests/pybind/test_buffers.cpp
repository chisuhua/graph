...
TEST(buffers, test_from_python) {
    py::scoped_interpreter guard{};
    auto m = py::module::import("buffers");
    auto np = py::module::import("numpy");
    // m.attr("Matrix")(np.attr("array")(std::list<int>{1, 2, 3}));
    // m.attr("Matrix")(np.attr("array")(std::list<int>{1, 2, 3}));
    // py::list lst;
    // std::list<std::list<int>> arr = {{1,2,3}, {4,5,6}};
    // auto m3 = np.attr("array")(std::list<int>{1, 2, 4});

}

PYBIND11_EMBEDDED_MODULE(buffers, m) {
