...
TEST(kwargs_and_defaults, test_named_arguments) {
    py::scoped_interpreter guard{};
    auto m = py::module::import("kwargs_and_defaults");
    CHECK_EQ(m.attr("kw_func0")(5, 10).cast<std::string>(), "x=5, y=10");
    CHECK_EQ(m.attr("kw_func1")(5, 10).cast<std::string>(), "x=5, y=10");
    CHECK_EQ(m.attr("kw_func1")(5, "y"_a=10).cast<std::string>(), "x=5, y=10");

    CHECK_EQ(m.attr("kw_func2")().cast<std::string>(), "x=100, y=200");
    CHECK_EQ(m.attr("kw_func2")(5).cast<std::string>(), "x=5, y=200");
    CHECK_EQ(m.attr("kw_func2")("y"_a=10).cast<std::string>(), "x=100, y=10");

    CHECK_EQ(m.attr("kw_func4")().cast<std::string>(), "{13 17}");
    CHECK_EQ(m.attr("kw_func4")("myList"_a=std::vector<int>{1, 2, 3}).cast<std::string>(), "{1 2 3}");
}

TEST(kwargs_and_defaults, test_arg_kwargs) {
    py::scoped_interpreter guard{};
    auto m = py::module::import("kwargs_and_defaults");
    // py::print(m.attr("args_function")(*(py::make_tuple("arg1_value", "arg2_value", 3))));

    CHECK_EQ(py::str(m.attr("args_function")(*(py::make_tuple("arg1_value", "arg2_value", 3)))).cast<std::string>()
            , R"(('arg1_value', 'arg2_value', 3))");
/*
    CHECK_EQ(py::str(m.attr("args_kwargs_function")(
                *(py::make_tuple('a1', 'a2')),
                **(py::dict("arg3"_a='a3', "arg4"_a=4)))).cast<std::string>(),
            R"(('arg1_value', 'arg2_value', 3), {})");
            */
}


PYBIND11_EMBEDDED_MODULE(kwargs_and_defaults, m) {
