...
TEST(BuildModule, Heterogeneous)
{
   ...
   */
    ...
    // Setup graph json.
    std::string json = "{\"nodes\": [{\"op\": \"null\", \"name\": \"A\", \"inputs\": []}, "
    ...
    const runtime::PackedFunc* graph_runtime = tvm::runtime::Registry::Get("tvm.graph_runtime.create");
