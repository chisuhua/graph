...
TEST(Relay, Sequential)
{
    ...
    relay::Function func = relay::FunctionNode::make(relay::FreeVars(z3), z3, relay::Type(), {});
    ...
    relay::Function expected_func = relay::FunctionNode::make(relay::FreeVars(zz), zz, relay::Type(), {});
